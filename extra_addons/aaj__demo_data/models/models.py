...
class inventario(models.Model):
    _name = 'aaj_demo_data.inventario'
    _description = 'aaj_demo_data.inventario'
    ...
    ids_compras = fields.One2many('aaj_demo_data.compra', 'id_inventario', string='Compras')
...
class comprador(models.Model):
    _name = 'aaj_demo_data.comprador'
    _description = 'aaj_demo_data.comprador'
    ...
    ids_compras = fields.One2many('aaj_demo_data.compra', 'id_comprador', string='Compras')
...
class compra(models.Model):
    _name = 'aaj_demo_data.compra'
    _description = 'aaj_demo_data.compra'


    id_inventario = fields.Many2one(comodel_name='aaj_demo_data.inventario', string='Inventario', required=True)
    id_comprador = fields.Many2one(comodel_name='aaj_demo_data.comprador', string='Comprador', required=True)
